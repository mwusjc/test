	...
	<div style="width: 100%; text-align: center;">
		...
		<?php
			...
			if (date("w") == 3 || date("w") == 4) {
				if ($activeflyer["Week"] >= time()) echo '
				<a class="button" href="mobile-flyer.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Upcoming Flyer</a>
				<a class="button" href="mobile-flyer-past.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;This Week\'s Flyer</a>
				';
			} else {
				echo '<a class="button" href="mobile-flyer.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;This Week\'s Flyer</a>';
			}
