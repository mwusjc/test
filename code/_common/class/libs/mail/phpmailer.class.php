...
class phpmailer
{
     ...
     *  @var string
     */
    var $Host        = "mail.thebrandfactory.com:25";
    ...
    */
    ...
    function smtp_send($header, $body) {
        ...
        // include_once($this->PluginDir . "phpmailer.smtp.class.php");
    ...
    function create_header() {
        ...
        $header[] = sprintf("X-Mailer: X-Mailer %s", $this->LE);
        if($this->Sender == "")
