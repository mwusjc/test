<div id="carousel" class="carousel slide home" data-ride="carousel" data-interval="6000" >
  ...
  <div class="carousel-inner" role="listbox">
    ...
    <a  href="/flyer"class="item responsive">
      <div class="carousel-item-container desktop col-xs-12 home-carousel-caption">
        <div class="row dow-product-desc-container">
          <p class="pull-left desktop dow-product-desc">Grade AAA Butterball Frozen Turkeys<br/>All Sizes<br/><h5 class="dow-product-details">Limit of 1 per family</h5></p>
        </div>
    ...
    <a href="/flyer" class="item responsive">
      <div class="carousel-item-container desktop col-xs-12 home-carousel-caption">
        <div class="row dow-product-desc-container">
          <p class="pull-left desktop dow-product-desc">FreshAAA Clementines<br/>Product of Morocco</p>
        </div>
