...
<main class='landing-2'>
  ...
  <div class="row box orange offer">
    ...
    <div class="col-md-9">
      ...
      <div class="row details">
        ...
        <div class="col-xs-6 col-md-6"><h3>Eco-friendly <br>shopping bag with <br>every purchase</h3></div>
      </div>
    </div>
  </div>
  <div class="row box orange calendar">
    ...
    <div class="col-md-4">
      <a href="https://calendar.google.com/calendar/render?action=TEMPLATE&text=Highland+Farms+Grand+Opening&dates=20170331T100000Z/20170331T120000Z&details=For+details,+link+here:+http://www.hfstartfresh.ca&location=9940+Dufferin+Street,+Vaughan,+ON,+L6A+4K5&sf=true&output=xml#">
...
<div class="container-fluid deli-header">
  <div class="row">
    <div class="col-md-6">
      <img src="<?=site_url()?>/assets/media/vaughan/deli-sign.jpg" width="100%">
    </div>
    <div class="col-md-6">
      <img src="<?=site_url()?>/assets/media/vaughan/platters-gifts.jpg" width="100%">
    </div>
  </div>
</div>
...
every aisle</h1>
  ...
  <div class="row">
    <h1 style="color: #f99d1c; font-size: 54px; font-family: 'HelveticaNeueLT-Bold'">Look for our deals... at your fingertips!</h1>
  </div>
  <div class="row">
    <p style="color:black; font-size: 20px; font-family: 'SerifaBT-Light';" >Great deals and savings every week! Subscribe to our e-flyer.</p>
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-12 social-icons" align="center">
