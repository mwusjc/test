...
<main class='careers'>
    <div class='row'>
        <div class='col-sm-12'>
            ...
            <p>We are always hiring. Please send your resume to<a href="mailto:jobs@highlandfarms.on.ca?subject=Resume from {your name here}" _target="blank">jobs@highlandfarms.on.ca</a></p>
        </div>
    </div>
