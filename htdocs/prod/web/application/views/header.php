...
<head>
    ...
    <link rel="stylesheet" href="../../assets/css/styles.css?rev=ad50c64c5031a122b16f7b8f58709526">
    <link rel="stylesheet" href="../../assets/css/mobile.css?rev=e7d5a049110ab0958ce35e018e98c38d">
...
<header>
    ...
    <nav class="desktop">
        <ul>
            <li><a class="link-menu" id="home" href='<?=site_url()?>'>Home</a></li>
            <li><a class="link-menu" id="flyer" href='<?=site_url()?>flyer'>Flyer</a></li>
            <li><a class="link-menu" id="recipes" href='<?=site_url()?>recipes'>Recipes</a></li>
            <li><a class="link-menu" id="insideTheStore" href='<?=site_url()?>inside-store'>Inside The Store</a></li>
            <li><a class="link-menu" id="countryKitchen" href='<?=site_url()?>country-kitchen'>Country Kitchen</a></li>
            <li><a class="link-menu" id="plattersAndGifts" href='<?=site_url()?>party-platters'>Platters & Gifts</a></li>
            <li><a class="link-menu" id="about" href='<?=site_url()?>about'>About</a></li>
            <li><a class="link-menu" id="visitUs" href='<?=site_url()?>visit-us'>Visit Us</a></li>
        </ul>
    </nav>
