var fl = {
  ...
  getWeekRange: function(week){
    ...
    if (range == "Fri Mar 18 2016 - Thu Mar 24 2016" || range == "Fri Mar 25 2016 - Thu Mar 31 2016") {
      range = "Fri Mar 18 2016 - Thu Mar 31 2016";
    }
    else if (range == "Fri Apr 01 2016 - Thu Apr 07 2016") {
  ...
  previewFlyers: function() {
    ...
    if(nextWeek == "20160331" && currentWeek == "20160324") {
      $("#thisWeekDates").html("Fri Apr 01 2016 - Thu Apr 07 2016");
      //Specify flyer for current week and next week due to start date exception on  upcoming flyer from current pattern
      $("#currentFlyer .flyerThumb").attr("src","/assets/flyers/20160317/mobile/page1.jpg");
      $("#nextFlyer .flyerThumb").attr("src","/assets/flyers/20160331/mobile/page1.jpg");
    }
  ...
  loadData: function(week,type){
    ...
    else if (week == "20160331" || week == "20160324") {
