var fl = {
  ...
  getWeekRange: function(week){
    ...
    if (range == "Fri Mar 04 2016 - Thu Mar 10 2016") {
      range = "Fri Mar 04 2016 - Thu Mar 10 2016";
    }
    else if (range == "Fri Mar 11 2016 - Thu Mar 17 2016") {
  ...
  previewFlyers: function() {
    ...
    if(nextWeek == "20160310" && currentWeek == "20160303") {
      $("#thisWeekDates").html("Fri Mar 11 2016 - Thu Mar 17 2016");
      //Specify flyer for current week and next week due to start date exception on  upcoming flyer from current pattern
      $("#currentFlyer .flyerThumb").attr("src","/assets/flyers/20160303/mobile/page1.jpg");
      $("#nextFlyer .flyerThumb").attr("src","/assets/flyers/20160310/mobile/page1.jpg");
    }
