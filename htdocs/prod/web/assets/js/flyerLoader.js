var fl = {
  ...
  getWeekRange: function(week){
    ...
    if (range == "Fri Apr 08 2016 - Thu Apr 14 2016") {
      range = "Fri Apr 08 2016 - Thu Apr 14 2016";
    }
    else if (range == "Fri Apr 15 2016 - Thu Apr 21 2016") {
      range = "Fri Apr 15 2016 - Thu Apr 21 2016";
    }
  ...
  previewFlyers: function() {
    ...
    if(nextWeek == "20160414" && currentWeek == "20160407") {
      $("#thisWeekDates").html("Fri Apr 15 2016 - Thu Apr 21 2016");
      //Specify flyer for current week and next week due to start date exception on  upcoming flyer from current pattern
      $("#currentFlyer .flyerThumb").attr("src","/assets/flyers/20160407/mobile/page1.jpg");
      $("#nextFlyer .flyerThumb").attr("src","/assets/flyers/20160414/mobile/page1.jpg");
    }
  ...
  loadData: function(week,type){
    ...
    else if (week == "20160414") {
      url = "/assets/flyers/20160414/"+type+"/data.json";
    }
