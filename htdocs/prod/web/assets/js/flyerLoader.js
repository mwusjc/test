var fl = {
  ...
  getWeekRange: function(week){
    ...
    if (range == "Fri Feb 12 2016 - Thu Feb 18 2016") {
      range = "Fri Feb 12 2016 - Thu Feb 18 2016";
    }
    else if (range == "Fri Feb 19 2016 - Thu Feb 25 2016") {
  ...
  previewFlyers: function() {
    ...
    if(nextWeek == "20160218" && currentWeek == "20160211") {
      $("#thisWeekDates").html("Fri Feb 19 2016 - Thu Feb 25 2016");
      //Specify flyer for current week and next week due to start date exception on  upcoming flyer from current pattern
      $("#currentFlyer .flyerThumb").attr("src","/assets/flyers/20160211/mobile/page1.jpg");
      $("#nextFlyer .flyerThumb").attr("src","/assets/flyers/20160218/mobile/page1.jpg");
    }
