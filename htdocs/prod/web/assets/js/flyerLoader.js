var fl = {
  ...
  getWeekRange: function(week){
    ...
    if (range == "Fri Feb 26 2016 - Thu Mar 03 2016") {
      range = "Fri Feb 26 2016 - Thu Mar 03 2016";
    }
    else if (range == "Fri Mar 04 2016 - Thu Mar 10 2016") {
      range = "Fri Mar 04 2016 - Thu Mar 10 2016";
    }
  ...
  previewFlyers: function() {
    ...
    if(nextWeek == "20160303" && currentWeek == "20160225") {
      $("#thisWeekDates").html("Fri Mar 04 2016 - Thu Mar 10 2016");
      //Specify flyer for current week and next week due to start date exception on  upcoming flyer from current pattern
      $("#currentFlyer .flyerThumb").attr("src","/assets/flyers/20160225/mobile/page1.jpg");
      $("#nextFlyer .flyerThumb").attr("src","/assets/flyers/20160303/mobile/page1.jpg");
    }
  ...
  loadData: function(week,type){
    ...
    else if (week == "20160303") {
      url = "/assets/flyers/20160303/"+type+"/data.json";
    }
