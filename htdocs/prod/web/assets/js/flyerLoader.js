var fl = {
  ...
  getWeekRange: function(week){
    ...
    if (range == "Fri Apr 01 2016 - Thu Apr 07 2016") {
      range = "Fri Apr 01 2016 - Thu Apr 07 2016";
    }
    else if (range == "Fri Apr 08 2016 - Thu Apr 14 2016") {
      range = "Fri Apr 08 2016 - Thu Apr 14 2016";
    }
  ...
  previewFlyers: function() {
    ...
    if(nextWeek == "20160407" && currentWeek == "20160331") {
      $("#thisWeekDates").html("Fri Apr 08 2016 - Thu Apr 14 2016");
      //Specify flyer for current week and next week due to start date exception on  upcoming flyer from current pattern
      $("#currentFlyer .flyerThumb").attr("src","/assets/flyers/20160331/mobile/page1.jpg");
      $("#nextFlyer .flyerThumb").attr("src","/assets/flyers/20160407/mobile/page1.jpg");
    }
  ...
  loadData: function(week,type){
    ...
    if(week == "20160331") {
      url = "/assets/flyers/20160331/"+type+"/data.json";
    }
    else if (week == "20160407") {
      url = "/assets/flyers/20160407/"+type+"/data.json";
    }
