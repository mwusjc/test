var fl = {
  ...
  getWeekRange: function(week){
    ...
    if (range == "Fri Feb 19 2016 - Thu Feb 25 2016") {
      range = "Fri Feb 19 2016 - Thu Feb 25 2016";
    }
    else if (range == "Fri Feb 26 2016 - Thu Mar 03 2016") {
      range = "Fri Feb 26 2016 - Thu Mar 03 2016";
    }
  ...
  previewFlyers: function() {
    ...
    if(nextWeek == "20160225" && currentWeek == "20160218") {
      $("#thisWeekDates").html("Fri Feb 26 2016 - Thu Mar 03 2016");
      //Specify flyer for current week and next week due to start date exception on  upcoming flyer from current pattern
      $("#currentFlyer .flyerThumb").attr("src","/assets/flyers/20160218/mobile/page1.jpg");
      $("#nextFlyer .flyerThumb").attr("src","/assets/flyers/20160225/mobile/page1.jpg");
    }
  ...
  loadData: function(week,type){
    ...
    if(week == "20160218") {
      url = "/assets/flyers/20160218/"+type+"/data.json";
    }
    else if (week == "20160225") {
      url = "/assets/flyers/20160225/"+type+"/data.json";
    }
