var fl = {
	...
	getWeekRange: function(week){
		...
		if (range == "Fri Jan 22 2016 - Thu Jan 28 2016") {
      range = "Fri Jan 22 2016 - Thu Jan 28 2016";
    }
    else if (range == "Fri Jan 29 2016 - Thu Feb 04 2016") {
	...
	previewFlyers: function() {
		...
		if(nextWeek == "20160128" && currentWeek == "20160121") {
			$("#thisWeekDates").html("Fri Jan 29 2016 - Thu Feb 04 2016");
			//Specify flyer for current week and next week due to start date exception on  upcoming flyer from current pattern
			$("#currentFlyer .flyerThumb").attr("src","/assets/flyers/20160121/mobile/page1.jpg");
			$("#nextFlyer .flyerThumb").attr("src","/assets/flyers/20160128/mobile/page1.jpg");
		}
