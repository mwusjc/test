...
class CFormTable extends CGridTable {
  ...
  function CFormTable($pID = "", $pWidth = "100%", $pHeight = "", $pBorder = "0", $pCellPadding = "0", $pCellSpacing = "0", $pClass = "") {
	$this->CTable($pID, $pWidth, $pHeight, $pBorder, $pCellPadding, $pCellSpacing, $pClass);
	$this->mObjects = array();
  }
